...
class MyGrpcClientService2DiffblueTest {
  /**
   * Test {@link MyGrpcClientService2#getUserName(String)}.
   *
   * <ul>
   ...
   * </ul>
   *
   * <p>Method under test: {@link MyGrpcClientService2#getUserName(String)}
   */
  @Test
  @DisplayName(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String MyGrpcClientService2.getUserName(String)"})
  void testGetUserName_givenUserResponseGetNameReturnName_when42_thenReturnName() {
    ...
    // Act
    String actualUserName = new MyGrpcClientService2(stub).getUserName("42");
